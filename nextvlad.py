...
class NeXtVLAD():
    ...
    def forward(self, input, mask=None, last_norm=True, last_reshape=True):
        print("nextvlad input shape: ", input.get_shape().as_list(), self.expansion, self.feature_size)
        ...
        tf.summary.histogram("cluster_assignments", activation)
...
class NeXtVLADModel(models.BaseModel):
    ...
    def create_model(self,
        ...
        print("model input shape: ", model_input.get_shape().as_list())
...
class MixNeXtVladModel(models.BaseModel):
    ...
    def create_model(self,
        ...
        max_frames = model_input.get_shape().as_list()[1]
        print("input_shape: ", model_input.get_shape().as_list())
